...
DOCS = [
    {"Nº Pedido": "P-26/004-S00", "Cliente": "ATLAS - ONUVA", "Nº PO": "7000100010",
     "Nº Doc. Cliente": "V-1234AB00A-1100-300-DL-001", "Nº Doc. EIPSA": "26-062-DL-0001",
     "Título": "DOCUMENTS LIST", "Tipo Doc.": "VDDL", "Nº Revisión": 0.0},
    {"Nº Pedido": "P-26/004-S00", "Cliente": "ATLAS - ONUVA", "Nº PO": "7000100010",
     "Nº Doc. Cliente": "V-1234AB00A-1100-300-OHFE-0014-CAL-001",
...
HUECOS = [
    {"clave": "CLIENT", "tipo": "etiqueta", "ejemplo": "ATLAS - PLANTA SUR (OSF)"},
    {"clave": "PROJECT", "tipo": "etiqueta", "ejemplo": "PLANTA SUR"},
    {"clave": "UNIT", "tipo": "etiqueta", "ejemplo": "OG"},
    {"clave": "PURCHASE ORDER N°", "tipo": "etiqueta", "ejemplo": "7000100010"},
    {"clave": "WOOD DWG. N°", "tipo": "etiqueta", "ejemplo": "V-1234AB00A-1100-300-DL-001"},
    {"clave": "VENDOR DOC. Nº", "tipo": "etiqueta", "ejemplo": "26-062-DL-0001"},
    {"clave": "MAT. REQ. Nº", "tipo": "etiqueta", "ejemplo": "RM-1234AB00A-1100-300"},
    {"clave": "VENDOR CAD FILE Nº", "tipo": "etiqueta",
     "ejemplo": "V-1234AB00A-1100-300-DL-001-R0.PDF"},
    {"clave": "CAD 2 CIFRAS", "tipo": "etiqueta",
     "ejemplo": "V-1234AB00A-1100-300-DL-001-R00.pdf"},
...
ok(s["CLIENT"] == "ATLAS - PLANTA SUR (OSF)", f"cliente: {s['CLIENT']!r}")
ok(s["PROJECT"] == "PLANTA SUR", f"proyecto: {s['PROJECT']!r}")
ok(s["MAT. REQ. Nº"] == "RM-1234AB00A-1100-300", f"nº de RM: {s['MAT. REQ. Nº']!r}")
...
ok(P.aplicar(s["WOOD DWG. N°"], v) == "V-1234AB00A-1100-300-OHFE-0014-CAL-001",
   "el hueco propuesto cambia con cada documento")
ok(P.aplicar(s["CLIENT"], v) == "ATLAS - PLANTA SUR (OSF)",
   "el texto fijo no cambia")
ok(P.aplicar(s["VENDOR CAD FILE Nº"], v) == "V-1234AB00A-1100-300-OHFE-0014-CAL-001-R1.PDF",
...
ok(sin["WOOD DWG. N°"] == "V-1234AB00A-1100-300-DL-001",
