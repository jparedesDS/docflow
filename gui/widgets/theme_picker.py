...
THEMES: list[dict] = [
    {
        "key":   "light",
        "label": "Claro",
        "subtitle": "Anthropic · papel cálido + azul",
        "icon":  "☀",
        "bg":    "#F5F4EF", "card": "#FFFFFF", "accent": "#185FA5",
        "text":  "#2C2C2A", "sub":  "#5F5E5A", "border": "#E7E5DD",
        "font":  "Segoe UI",
    },
    {
        "key":   "dark",
        "label": "Oscuro",
        "subtitle": "Anthropic · warm dark + azul",
        "icon":  "☾",
        "bg":    "#1C1B19", "card": "#242321", "accent": "#5B9BE0",
        "text":  "#F0EEE6", "sub":  "#B4B2A9", "border": "#393734",
        "font":  "Segoe UI",
    },
    {
        "key":   "light-coral",
