...
def _build_merged_dataset() -> list[dict]:
    ...
    # uppercase + strip para tolerar variaciones de case (P-26/415-S00 vs
    # P-26/415-s00) y espacios accidentales.
    if not consulta_df.empty and "Nº Pedido" in consulta_df.columns:
        ...
        # Cliente = cliente FINAL / planta del ERP (NORDIC, ATLAS, OMEGA…), no la
