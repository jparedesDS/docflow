...
def norm_cliente(valor) -> str:
    ...
    El ERP tiene «DELTA» y «Delta», o «ACME NORTE» y «ACME / NORTE», que
    son el mismo cliente escrito de dos formas y salían como dos filas. Se pasa
    a mayúsculas y se unifica el separador. No se toca nada más: «ACME» a
    secas se queda aparte de «ACME NORTE», que puede ser otro proyecto.
    """
