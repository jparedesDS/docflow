...
texto normal con campos del ERP entre llaves.
    ...
    PLANTA        →  3000000001-1100-3000      (fijo, el mismo para el pedido)
    FECHA         →  {Fecha}
...
que el segundo pedido de ATLAS ya sale solo.
...
CAMPOS: list[tuple[str, str]] = [
    ...
    ("Nº Pedido",       "Pedido de EIPSA (P-26/023)"),
...
def _tag(doc: dict) -> str:
    ...
    o en su título, que es lo que hacen todos los clientes:
        ...
        V-1234AB00A-1100-300-OHFE-0014-CAL-001   →  OHFE 0014
