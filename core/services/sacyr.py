...
del asunto**, cambiando la barra por un guion bajo:
    ...
    WF#: 4000079-PRY001-627-J-C.181752/01-SP-OBTS-000005
    →    4000079-PRY001-627-J-C.181752_01-SP-OBTS-000005
...
#   «… WF#:4000079-PRY001-…-SP-OBTS-000005 - DISC:270 - PO:PRY001-… OBTS-000005»
...
def casa_documento(codigo: str, nombre: str, rev=None) -> bool:
    ...
    Los PDF que publica SACYR llevan el código **del ERP**, no el del correo:
        ...
        correo   PRY001-627-J-C.181752/01-00002
        fichero  V-PRY001-627-J-C.181752_01-002_R0_A.pdf
...
#
#     V-PRY001-627-J-C.181752_01-002_R0_A.pdf   → rev 0, código A
#     V-PRY001-627-J-C.181752_01-003-R1_B.pdf   → rev 1, código B
#
