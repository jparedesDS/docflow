...
# por la clave del proyecto: "[PRY&001-CI0021-HS-EI-T-0029] …". Del mismo
...
#   · avisos de workflow     "[VDTR-CI-1602] PRY&001-CI0021-EIPSA-HS-T-0063"
...
def _get_project_key(transmittal_code: str | None) -> str:
    ...
    if not transmittal_code:
        return ""
    # Ej: "PRY&001-CI0021-HS-EI-T-0029" → "PRY&001"
