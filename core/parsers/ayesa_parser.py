...
3000000001-1100-3000, códigos V-3005785-1100-300-XXX-NNN) que NO está en
...
# Una devolución real de AYESA empieza por su código: "P03_3630_EIP-1100-300-008: Documentos de …".
...
def extract_transmittal_code(subject: str) -> str | None:
    """Primer token del asunto (p.ej. 'P03_3630_EIP-1100-300-001')."""
