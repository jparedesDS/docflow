...
cliente::
    ...
    Supplier Document Issue: 4000079 - WF#:4000079-PRY001-627-J-C.181752/01-SP-OBTS-000002
    - DISC:270 - PO:PRY001-627-J-C.181752/01 OBTS-000002
...
· **La numeración del correo no es literalmente la del ERP.** SACYR escribe
  ``PRY001-627-J-C.181752/01-00004`` y en el ERP ese mismo documento está como
  ``V-PRY001-627-J-C.181752/01-004``: sobra el prefijo del proveedor y el nº de
...
def _erp_by_po(po: str) -> dict | None:
    ...
    el ERP guarda «C.181752/01» y SACYR manda «PRY001-627-J-C.181752/01».
    """
    po = norm_doc_code(po)
    if len(po) < _MIN_BASE:
        return None
